...
INVERTER_DEFS = {
    "SOLIS_PHO3NIX_MODBUS": {
        ...
        "default_config": {
            ...
            "id_consumption_today": "sensor.{device_name}_today_energy_consumption",
            "id_grid_power": "sensor.{device_name}_meter_total_active_power",
            "id_grid_import_today": "sensor.{device_name}_today_energy_imported_from_grid",
            "id_grid_export_today": "sensor.{device_name}_today_energy_fed_into_grid",
        ...
        "brand_config": {
            ...
            "id_inverter_mode": "select.{device_name}_work_mode",
            "id_backup_mode_soc": "sensor.{device_name}_overdischarge_offgrid_soc",
        },
    },
    "SOLIS_SOLAX_MODBUS": {
